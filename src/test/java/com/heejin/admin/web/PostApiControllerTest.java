...
public class PostApiControllerTest {
    ...
    public void Posts_등록된다() throws Exception{
        ...
        PostSaveRequestDto requestDto = PostSaveRequestDto.builder().title(title)
                                                                    .content(content)
                                                                    .author("author")
                                                                    .build();
    ...
    @Test
    public void Post_수정되다() throws Exception{
        ...
        PostUpdateRequestDto requestDto = PostUpdateRequestDto.builder().title(expectedTitle)
